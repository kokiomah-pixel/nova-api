...
| --- | --- | --- | --- | --- | --- |
| YYYY-MM-DD | Example: scheduled token rotation | Example: GitHub automation credential | Example: revoked old credential and issued least-privilege replacement | Example: pending workflow verification | Example: owner / open |
