...
| --- | --- | --- | --- | --- | --- |
| YYYY-MM-DD | Example: repository hygiene review | Example: docs and scripts | Example: security lint executed and findings remediated | Example: none identified | Example: owner / closed |
