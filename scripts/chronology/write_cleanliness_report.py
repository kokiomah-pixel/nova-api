...
from chronology_common import ROOT, atomic_write_json
...
def build_report() -> dict:
    ...
    return {"schema_version": "1.0.0", "generated_at": generated_at, "source_commit": source_commit, "validation_status": validation["status"], "freshness": {"source_commit": source_commit, "generated_at": generated_at, "maximum_age_hours": 24}, "lanes": lanes, "unsupported_claims": validation["unsupported_claims"], "unresolved_items": unresolved + validation["errors"]}
